...
?>
<fieldset>
    <legend><img src="../images/menus/report-expire.png"/></legend>
    ...
    if (!empty($_GET['action'])) {
        ...
        $sql .= " FROM pawn p ";
        $sql .= " JOIN member m ON m.mem_id = p.mem_id WHERE  sta_id =  " . $_pawn_status['PAWN-EXPIRE'];
        ...
        ?>
        <div id="export">
            <div style="text-align: center;font-size: 25px;">รายงานสินคาหลุดจํานํา</div>
