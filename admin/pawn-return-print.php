<html>
    ...
    <body>
        <fieldset id="fieldsetPawnPrint">            
            <legend>ใบเสร็จรับเงิน [เลขที่ตั๋วใบจำนำเลขที่ <?= $pawn_code ?>]</legend>
            <table border="0" width="100%">
                <tbody>
                    ...
                    <tr>
                     ...
                     <tr>                        
                        <td>ยอดเงินค่าชำระค่าไถ่ถอนสินค้าคืน</td>
                        <td><?= $pawn_pay ?> บาท</td>
                        <td>วันที่ขำระค่าบริการไถ่ถอนสินค้า</td>
                        <td><?= $pawn_date_return ?></td>
                    </tr>
                     <tr>                        
                        <td>ยอดเงินค้างชำระคงเหลือ</td>
                        <td><?= $pawn_money ?> บาท</td>
                        <td></td>
                        <td></td>
                    </tr>
                    <tr>
